...
$jumlah_pesanan = mysqli_num_rows($produks); //jumlah pesanan
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card aligns-items-center justify-content-center w-75 mx-auto text-center">
            <div class="card-header">Total</div>
            <div class="card-body">
              <h5 class="card-title">Jumlah Produk Saat Ini:</h5>
            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <?php 
                  ...
                  while ($produk = mysqli_fetch_array($ambildata)) {
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <a href="update.php?id=<?php echo $produk ["id"]; ?>">
                    <button type="button" class="btn btn-primary col-md-5 text-center" name="update">
                      <i class="bi bi-pencil-square text-center"></i>
                    </button>
                    </a>
                        
                    <a href="delete.php?id=<?php echo $produk ["id"]; ?>">
                    <button type="button" class="btn btn-danger col-md-5 text-center" name="hapus" onClick="javascript: return confirm('Please confirm deletion');">
